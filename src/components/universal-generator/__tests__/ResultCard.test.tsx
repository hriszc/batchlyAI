...
describe("ResultCard", () => {
  ...
  it("renders video media with a video player", () => {
    ...
    renderWithProviders(<ResultCard result={videoResult} showWatermark />);

    const video = screen.getByLabelText("A cat in a forest");
