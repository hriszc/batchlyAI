...
describe("sanitizeFilename", () => {
  it("returns clean filename unchanged", () => expect(sanitizeFilename("photo.png")).toBe("photo.png"));
  it("replaces slashes with underscores", () => expect(sanitizeFilename("a/b/c.png")).toBe("a_b_c.png"));
  it("replaces special chars", () => expect(sanitizeFilename("my photo (1).png")).toBe("my_photo__1_.png"));
  ...
  it("truncates to 200 chars", () => expect(sanitizeFilename("a".repeat(250) + ".png").length).toBeLessThanOrEqual(200));
  ...
  it("preserves dots and hyphens", () => expect(sanitizeFilename("my-file.v1.0.png")).toBe("my-file.v1.0.png"));
});
