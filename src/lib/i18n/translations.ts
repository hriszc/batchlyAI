export const translations = {
  en: {
    ...
    forgotPasswordSent: "If an account with that email exists, we've sent a password reset link.",
    sendResetLink: "Send reset link",
    sending: "Sending...",
    backToLogin: "Back to login",
    verifyEmailDesc: "Please check your email to verify your account.",
    modelImage: "Image",
    modelVideo: "Video",
    modelText: "Text",
    modelMusic: "Music",
  ...
  zh: {
    ...
    forgotPasswordSent: "如果该邮箱对应的账户存在，我们会发送密码重置链接。",
    sendResetLink: "发送重置链接",
    sending: "发送中...",
    backToLogin: "返回登录",
    verifyEmailDesc: "请查看您的邮箱以验证账户。",
    modelImage: "生图",
    modelVideo: "生视频",
    modelText: "生文",
    modelMusic: "生音乐",
